...
function ladeNeueNachrichten()
{
  ...
  if(document.getElementById("gruppenNachrichtId").style.visibility == "visible"){
    setTimeout(() => { zeigeGruppenChatNachrichtenNeue(); }, 100);
...
function zeigeGruppenChatNachrichtenNeue(){
  ...
  for (let i = count; i < gruppenNachrichten.length; i++) {
    document.getElementById('gruppenChatNachrichtenId').innerHTML += "<p>" +  gruppenNachrichten[i].sender + " : " + gruppenNachrichten[i].text + "</p>";
...
function zeigePrivatNachrichtenNeue(){
  ...
  for (let i = count; i < privatNachrichtenFilter.length; i++) {
    document.getElementById('gruppenChatNachrichtenId').innerHTML += "<p>" +  privatNachrichtenFilter[i].sender + " : " + privatNachrichtenFilter[i].text + "</p>";
